...
export const ARTIST_INFO = {
  name: "NOKA AXL",
  title: "ELECTRONIC MUSIC PRODUCER & MAIN-STAGE DJ",
  tagline: "HIGH-VOLTAGE SONIC EXPERIENCES CRAFTED FOR STADIUMS AND UNDERGROUND CATHEDRALS",
  bpmRange: "128 — 145 BPM",
  genres: ["MAIN-STAGE HYBRID", "HARD TECHNO", "FUTURE BASS", "PSY-PROGRESSIVE"],
  origin: "INDONESIA / GLOBAL TOURING",
  status: "WORLD TOUR 2026 // ACCEPTING BOOKINGS",
  totalStreams: "18.4M+",
  monthlyListeners: "850K+",
  festivalAppearances: "120+",
  yearsActive: "7+ YEARS",
...
export const TRACKS_DATA: Track[] = [
  {
    id: "track-1",
    title: "NEO ECLIPSE (VIP EDIT)",
    featuredArtist: "ft. Cyber Echo",
    bpm: 138,
    key: "F# Min",
    duration: "03:42",
  ...
  {
    id: "track-2",
    title: "RESURGENCE (ORIGINAL MIX)",
    featuredArtist: "Solo",
    bpm: 132,
    key: "A Min",
    duration: "04:15",
    genre: "Future Rave / Bass",
    releaseYear: 2025,
  ...
  },
  {
    ...
    featuredArtist: "ft. Vexen",
    bpm: 142,
    key: "D Min",
    duration: "03:58",
    genre: "Acid Peak Techno",
    releaseYear: 2025,
  ...
  {
    id: "track-4",
    title: "AFTERMATH HORIZON",
    featuredArtist: "ft. Luna Ray",
    bpm: 128,
    key: "C Maj",
    duration: "04:30",
  ...
  },
  {
    ...
    featuredArtist: "NOKA AXL Remix",
    bpm: 145,
    key: "E Min",
    duration: "03:20",
    genre: "Hardstyle Hybrid",
    releaseYear: 2024,
    coverImage: "/assets/image-5.jpeg",
    spotifyUrl: "https://open.spotify.com",
    soundCloudUrl: "https://soundcloud.com",
    beatportUrl: "https://beatport.com",
    audioPreviewNote: "hard-drop",
    streams: "2.9M"
  }
];
